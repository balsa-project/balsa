# Forked from https://github.com/tensorflow/lingvo/blob/master/lingvo/core/hyperparams.py
# Balsa changes:
#  - commented out dependencies from lingvo (compat, proto, symbolic)
#  - commented out the dataclasses dependency
#  - added Params.__iter__()
#  - factored out a helper ToFlattenedTextDict()
#
# An alternative: https://github.com/tensorflow/tensor2tensor/blob/master/tensor2tensor/utils/hparam.py
#
# Lint as: python3
